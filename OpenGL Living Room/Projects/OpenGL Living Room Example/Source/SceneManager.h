...
public:
	...
	void RenderScene();
	void DrawWalls();
	void DrawTVStand(float xPos, float yPos, float zPos);
	void DrawTV(float xPos, float yPos, float zPos);
	void DrawPictureFrame(float xPos, float yPos, float zPos);
	void DrawBookcase(float xPos, float yPos, float zPos);
	void DrawTuffet(float xPos, float yPos, float zPos);
	void DrawTable(float xPos, float yPos, float zPos);
	void DrawLamp(float xPos, float yPos, float zPos);
	void DrawSquirtBottle(float xPos, float yPos, float zPos);
};