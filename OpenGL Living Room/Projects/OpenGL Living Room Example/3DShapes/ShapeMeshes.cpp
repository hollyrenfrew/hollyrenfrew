...
//	glDrawArrays(GL_TRIANGLE_STRIP, 0, meshes.gPyramid4Mesh.nVertices);
///////////////////////////////////////////////////
void ShapeMeshes::LoadFrustumMesh()
{
	// Define a tapered frustum: bottom 1x1, top 0.5x0.5, height 1.0
	GLfloat verts[] = {
		// Bottom Face (Y = -0.5)
		...
		// Top Face (Y = 0.5)
		-0.25f, 0.5f, -0.25f,   0, 1, 0,   0.0f, 0.0f,
		0.25f, 0.5f, -0.25f,    0, 1, 0,   1.0f, 0.0f,
		0.25f, 0.5f,  0.25f,    0, 1, 0,   1.0f, 1.0f,
		-0.25f, 0.5f,  0.25f,   0, 1, 0,   0.0f, 1.0f,

		// Front face
		-0.5f, -0.5f, 0.5f,   0, 0, 1,   0.0f, 0.0f,
		0.5f, -0.5f, 0.5f,    0, 0, 1,   1.0f, 0.0f,
		0.25f, 0.5f, 0.25f,   0, 0, 1,   1.0f, 1.0f,
		-0.25f, 0.5f, 0.25f,  0, 0, 1,   0.0f, 1.0f,
		...
		-0.25f, 0.5f, 0.25f,  -1, 0, 0,  1.0f, 1.0f,
		-0.25f, 0.5f, -0.25f, -1, 0, 0,  0.0f, 1.0f,
	...
	m_FrustumMesh.nVertices = sizeof(verts) / (sizeof(GLfloat) * 8);
	glGenVertexArrays(1, &m_FrustumMesh.vao);
	glBindVertexArray(m_FrustumMesh.vao);

	glGenBuffers(1, m_FrustumMesh.vbos);
	glBindBuffer(GL_ARRAY_BUFFER, m_FrustumMesh.vbos[0]);
	glBufferData(GL_ARRAY_BUFFER, sizeof(verts), verts, GL_STATIC_DRAW);
...
//	DrawFrustumMesh()
//
//	Transform and draw the frustum mesh to the window.
// 
///////////////////////////////////////////////////
void ShapeMeshes::DrawFrustumMesh()
{
	glBindVertexArray(m_FrustumMesh.vao);

	glDrawArrays(GL_TRIANGLES, 0, m_FrustumMesh.nVertices);
